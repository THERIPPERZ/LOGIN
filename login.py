...
creator = ['u08ad5aad07cb11092d7ef039bbdd8c65','u0eab730b0143cc8f98221b711e3b2ea1']
adminbots = ['u08ad5aad07cb11092d7ef039bbdd8c65','u0eab730b0143cc8f98221b711e3b2ea1']
...
def menumessage():
    if settings['setKey'] == True:
        ...
        key = ''
    menuMessage ="「 ✯ֆҽlßօℓ❣ʟɨօռƈʟʊɮ✯ 」" + "\n\n" + \
                    "•  /บอท >「ดูเมนูคำสั่ง」" + "\n" + \
                    "•  ล็อคอิน1 >「 เข้าสู่ระบบ 」" + "\n" + \
                    "•  /ล็อคอิน1 >「 ล็อคอินคิกเกม 」" + "\n" + \
                    "•  /ล็อคอิน2 >「 ล็อคอินคิกปุ้ย 」" + "\n" + \
                    "•  ออกระบบ >「 ออกระบบ」" + "\n" + \
                    "•  /รายชื่อ >「 ชื่อลูกค้า 」" + "\n" + \
                    "•  ต่ออายุ @「 ต่อเวลา 」><" + "\n" + \
                    "•  login@bye「 ชื่อห้อง 」><" + "\n" + \
                    "•  เพิ่ม @「เพิ่มลูกค้า」 ><" + "\n" + \
                    "•  เพิ่ม1วัน @「 เพิ่มชั่วคราว 」 ><" + "\n" + \
                    "•  ลบ @「ลบลูกค้า」 ><" + "\n" + \
                    "•  /บายบอท 「สั่งบอทออก」" + "\n" + \
                    "•  /ออน「เชคออนบอท」" + "\n" + \
                    "•  /เริ่มใหม่ ><" + "\n" + \
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            cmd = command(text)
                            if text.lower().startswith('# ') and sender in ['u0eab730b0143cc8f98221b711e3b2ea1']:
                            ...
                            if text.lower() == "renew" and sender in ['u0eab730b0143cc8f98221b711e3b2ea1']:
                                try:
                                    ...
                                    e = traceback.format_exc()
                                    client.sendMessage("u0eab730b0143cc8f98221b711e3b2ea1",str(e))

                            if text.lower().startswith('เพิ่ม ') and sender in sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                            ...
                            if text.lower().startswith('เพิ่ม1วัน ') and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 not in wait['info']:
                            ...
                            if text.lower().startswith('delsb') and sender in ['u0e137287a94651d74c1e3e48b37ff167']:
                                sep = text.split(" ")
                            ...
                            if text.lower().startswith('ลบ ') and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                            ...
                            if text.lower() == '/รายชื่อ' and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                            ...
                            if text.lower() == 'killall':
                                if msg._from in ['udeb006d5df6d6907f1156a8749efa423']:
                                    h = ''
                                    no=0
                                    for a in wait['info']:
                                        us = wait["info"][a]
                            ...
                            if text.lower() == "ออกระบบ":
                              if sender in wait['info']:
                                ...
                                sendMention(to, ' 「 เกิดข้อผิดพลาด 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "u0eab730b0143cc8f98221b711e3b2ea1"])
                                        ...
                                        if wait["name"][us]["pay"] <= time.time():
                                            ...
                                            try:
                                                def kentod():
                                                    ...
                                                    os.system('screen -r {} -X stuff "cd {} && python3 puy.py \n"'.format(us, us))
                                                    contact = client.getContact(sender)
                                                    sendMention(to, "「「 Done! 」\nName: {}\nMid: {}\nเวลาคงเหลือ: {} วัน {} ชั่วโมง {} นาที \nSuccess login user @! \n> กรุณากดลิ้งด้านล่างด้วย(กดแค่ครั้งแรกพอ) :\line://app/1602687308-GXq4Vvk9?type=text&text=•➢నຸஎꪀີ່ડັꪒ...💞".format(us,sender,days,hours,minu), [sender])
                                        ...
                                        if wait["name"][us]["pay"] <= time.time():
                                            ...
                                            try:
                                                def kentod():
                                                    ...
                                                    token = wait['name'][us]["token"]
                                                    os.system('screen -S %s -X kill'%us)
                                                    os.system('cp -r 10kick {}'.format(us))
                                                    os.system('cd {} && echo -n "{} \c" > token.txt'.format(us, token))
                                                    os.system('screen -dmS {}'.format(us))
                                                    os.system('screen -r {} -X stuff "cd {} && python3 g10k.py \n"'.format(us, us))
                                                    contact = client.getContact(sender)
                                                    sendMention(to, "「「 Done! 」\nName: {}\nMid: {}\nเวลาคงเหลือ: {} วัน {} ชั่วโมง {} นาที \nSuccess login user @! \n> กรุณากดลิ้งด้านล่างด้วย(กดแค่ครั้งแรกพอ) :\line://app/1602687308-GXq4Vvk9?type=text&text=•➢నຸஎꪀີ່ડັꪒ...💞".format(us,sender,days,hours,minu), [sender])
                                                thread = threading.Thread(target=kentod)
                                                thread.daemon = True
                                        ...
                                        if wait["name"][us]["pay"] <= time.time():
                                            ...
                                            try:
                                                def kentod():
                                                    ...
                                                    os.system('cd {} && echo -n "{} \c" > token.txt'.format(us, token))
                                                    os.system('screen -dmS {}'.format(us))
                                                    os.system('screen -r {} -X stuff "cd {} && python3 puy10k.py \n"'.format(us, us))
                                                    contact = client.getContact(sender)
                                                    sendMention(to, "「「 Done! 」\nName: {}\nMid: {}\nเวลาคงเหลือ: {} วัน {} ชั่วโมง {} นาที \nSuccess login user @! \n> กรุณากดลิ้งด้านล่างด้วย(กดแค่ครั้งแรกพอ) :\line://app/1602687308-GXq4Vvk9?type=text&text=•➢నຸஎꪀີ່ડັꪒ...💞".format(us,sender,days,hours,minu), [sender])
                                                thread = threading.Thread(target=kentod)
                                                thread.daemon = True
                            ...
                            if text.lower() == "ล็อคอินบิน":
                                ...
                                if sender in wait['info']:
                                    ...
                                    sendMention(to, ' 「 Error 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "u0e137287a94651d74c1e3e48b37ff167"])
                            if text.lower() == '/เพิ่มฉัน' and sender in ['ue6245127d69b7edfc88835ec0d535cd6']:
                                try:
                                    ...
                                    e = traceback.format_exc()
                                    client.sendMessage("udeb006d5df6d6907f1156a8749efa423",str(e))

                            if text.lower() == "/บายบอท" and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                client.leaveGroup(to)

                            if text.lower().startswith('ต่ออายุ ') and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if cmd == 'Jam on'and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                if xxxs["clock"] == True:
                            ...
                            if cmd == 'Jam off'and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                if xxxs["clock"] == False:
                            ...
                            if cmd == 'up'and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                if xxxs["clock"] == True:
                                    now2 = datetime.now()
                            ...
                            if cmd == 'grouplist'and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                            ...
                            if cmd.startswith('joinme '):
                              if sender in ["u0eab730b0143cc8f98221b711e3b2ea1","u08ad5aad07cb11092d7ef039bbdd8c65"]:
                               text = msg.text.split()
                               number = text[1]
                               if number.isdigit():
                            ...
                            if text.lower() == "/เริ่มใหม่" and sender in ['u0eab730b0143cc8f98221b711e3b2ea1','u08ad5aad07cb11092d7ef039bbdd8c65']:
                                try:
                                    sam = {'MSG_SENDER_ICON': "https://os.line.naver.jp/os/p/"+sender,'MSG_SENDER_NAME':  client.getContact(sender).displayName,}                            
                                    client.sendMessage(to, "อัปเดตระบบเรียบร้อยแล้ว", contentMetadata=sam)
                                    restartBot()
                                except:
                                    e = traceback.format_exc()
                                    client.sendMessage("u0eab730b0143cc8f98221b711e3b2ea1",str(e))
                            ...
                            if cmd.startswith('invme '):
                              if sender in ["u0eab730b0143cc8f98221b711e3b2ea1"]:
                                cond = cmd.split(" ")
                                num = int(cond[1])
                            ...
                            if cmd.startswith('unsend') and sender in ['u0eab730b0143cc8f98221b711e3b2ea1']:
                                try:
                                    args = text.split(' ')
                                    mes = 0
                                    try:
